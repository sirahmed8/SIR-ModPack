...
## 3. Grant of License & Permitted Use
...
## 2. الامتثال للعلامة التجارية لـ Mojang و Microsoft
**هذا المنتج ليس منتجاً رسمياً لماينكرافت. غير معتمد من أو مرتبط بـ MOJANG أو MICROSOFT.**
1. **مشروع مجتمعي مستقل:** ماينكرافت علامة تجارية مسجلة لشركة Mojang AB و Microsoft Corporation. منظومة SIR هي مشروع مجتمعي مستقل بنسبة 100% وليست منتجاً رسمياً لماينكرافت.
2. **إرشادات الاستخدام التجاري:** يتوافق هذا التوزيع مع إرشادات الاستخدام التجاري لماينكرافت. لا يتم بيع أي كود مصدري أو أصول تجارية خاصة بماينكرافت، ويتم جلب الملفات الأصلية مباشرة من خوادم Mojang/Microsoft الرسمية.

---

## 3. منح الترخيص والاستخدام المصرح به
...
## 4. القيود والمحظورات الصريحة
يوافق المستخدم صراحة على عدم:
- إعادة توزيع نسخ معدلة من اللانشر أو المثبت تحت العلامة التجارية "SIR ModPack" دون إذن خطي مسبق.
- حقن أي برمجيات خبيثة أو برامج تجسس أو تتبع غير مصرح به في البرمجيات.
- استخدام المنظومة لانتهاك قواعد خوادم اللعب الجماعي أو تجاوز قيود الحماية.

---

## 5. ضمان الخصوصية وانعدام التتبع (Zero-Telemetry)
وفقاً لـ [سياسة الخصوصية](PRIVACY.md)، تعمل منظومة SIR وفق معيار **انعدام التتبع التام والخصوصية بالتصميم**:
- لا تتضمن المنظومة أي ملفات تعريف ارتباط إعلانية أو أكواد مراقبة سلوكية.
- تتم مصادقة حسابات مايكروسوفت حصرياً عبر خوادم هوية Microsoft الرسمية المرتبطة بـ localhost (`127.0.0.1`).
- يستخدم جسر الاقتران بين سطح المكتب والويب رابطاً محلياً يرتبط فقط بـ `127.0.0.1:52136` مع التحقق برمز أمان في زمن ثابت.
- تُحفظ كافة إعدادات المستخدم وتخصيصات الفيديو والبروفايلات محلياً على جهازك في مسار `%APPDATA%\SIR ModPack\`.

---

## 6. إخلاء المسؤولية وحدود الضمان
1. **الأساس "كما هو":** يتم توفير منظومة SIR على أساس **"كما هي" (AS IS)** و**"حسب المتاح"** دون أي ضمانات من أي نوع.
2. **حدود المسؤولية:** لا يتحمل المطورون في أي حال من الأحوال أي مسؤولية عن أي أضرار مباشرة أو غير مباشرة ناتجة عن استخدام أو عدم القدرة على استخدام البرنامج.
