...
class SIRLauncherApp(tk.Tk):
    ...
    def start_live_presence_listener(self):
        ...
        while True:
            try:
                ...
                my_ign = getattr(self, "selected_account", "Player") or "Player"
    ...
    def load_accounts(self):
        default_acc = [{"name": "Player", "type": "Offline", "skinUrl": "https://mc-heads.net/skin/Player", "active": True}]
    ...
    def scan_instances(self):
        ...
        KNOWN_PROFILES = {
            "26.2-ultra": {"name": "SIR 26 Visuals", "tag_name": "SIR 26 Visuals", "ver": "26.2", "loader": "Fabric", "desc": "Maximum visual fidelity with volumetric atmosphere, 3D POM relief, and crystal water caustics.", "group": "Modern 26", "tag_color": "#ff3b5c", "banner_color": "#3b0764", "artwork": "🌌"},
            "26.2-balanced": {"name": "SIR 26 Balanced", "tag_name": "SIR 26 Balanced", "ver": "26.2", "loader": "Fabric", "desc": "High refresh standard with physics sun/moon, custom shaders, and 3D textures.", "group": "Modern 26", "tag_color": "#00e5ff", "banner_color": "#450a0a", "artwork": "🔴"},
            "26.2-competitive": {"name": "SIR 26 Performance", "tag_name": "SIR 26 Perf", "ver": "26.2", "loader": "Fabric", "desc": "Low latency, stripped overhead, and responsive frame-timing for high-refresh gaming.", "group": "Modern 26", "tag_color": "#38ef7d", "banner_color": "#083344", "artwork": "⚡"},
            ...
            "1.8.9-ultra": {"name": "SIR 1.8.9 Visuals", "tag_name": "1.8.9 Visuals", "ver": "1.8.9", "loader": "Forge", "desc": "Enhanced 1.8.9 classic suite with dynamic animations, custom motion blur, and clean HUD.", "group": "Legacy 1.8", "tag_color": "#a855f7", "banner_color": "#1e1b4b", "artwork": "👑"},
            "1.8.9-balanced": {"name": "SIR 1.8.9 Balanced", "tag_name": "1.8.9 Balanced", "ver": "1.8.9", "loader": "Forge", "desc": "Balanced legacy configuration with smooth 1.8.9 combat mechanics and IAS account switcher.", "group": "Legacy 1.8", "tag_color": "#06b6d4", "banner_color": "#083344", "artwork": "🌊"},
            "1.8.9-pvp": {"name": "SIR 1.8.9 Performance", "tag_name": "1.8.9 Perf", "ver": "1.8.9", "loader": "Forge", "desc": "Tournament performance profile for Minemen, Hypixel, and ranked duels.", "group": "Legacy 1.8", "tag_color": "#ef4444", "banner_color": "#164e63", "artwork": "⚔️"},
            "1.8.9-speed": {"name": "SIR 1.8.9 Performance", "tag_name": "1.8.9 Perf", "ver": "1.8.9", "loader": "Forge", "desc": "Ultra lightweight build for high refresh performance on any PC.", "group": "Legacy 1.8", "tag_color": "#38ef7d", "banner_color": "#064e3b", "artwork": "⚡"},
    ...
    def open_game_settings_modal(self):
        ...
        if "linked_socials" not in self.settings:
            self.settings["linked_socials"] = {"discord": ""}
                ...
                "categories": [
                    ...
                    },
                    {
                        ...
                        "items": [
                            ...
                            "Global Real-Time Broadcast Engine: Push instant live announcement alerts from [Owner Page].",
...
"""
    ...
    def open_edit_instance_modal(self):
        ...
        tk.Label(sh_card_head, text="Select your active SIR Modern Shader preset for crystal water, circular glowing sun & 3D POM relief.", font=("Segoe UI", 8), bg=c["card_bg"], fg=c["text_secondary"]).pack(anchor="w", pady=(1, 10))
