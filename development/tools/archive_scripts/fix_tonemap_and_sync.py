...
print("==================================================")
print("  FIXING TONEMAP PRESET VARIABLE (DoBSLTonemap)   ")
print("==================================================")

# Update Aetheris_Shader_Pack.txt
with open(AETHERIS_TXT, "r", encoding="utf-8") as f:
    text = f.read()

text = text.replace("tonemap=AetherisMasterGrade", "tonemap=DoBSLTonemap")
text = text.replace("tonemap = AetherisMasterGrade", "tonemap = DoBSLTonemap")
...
print("\n==================================================")
print("  TONEMAP ERROR FIXED & SYNCHRONIZED ACROSS ALL!  ")
print("==================================================")
