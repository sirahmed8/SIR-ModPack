...
print("==================================================")
print("  MERGING USER ULTRA SETTINGS INTO MASTER PRESET  ")
print("==================================================")

# Master Ultra Preset merging user's exact selections with LabPBR & Fluid fixes
master_ultra_config = """# Aetheris Shader Pack v8.0 - User Master Ultra Edition
# Maximum Visual Quality + LabPBR 64x + Smooth Fluid Water + Volumetric Sunbeams & Atmosphere
profile=RTX4050
profile2=AETHERIS
...
for prof in PROFILES:
    if os.path.exists(prof):
        ...
        print(f"Synced Master Ultra shader to {sp_dir}")

print("\n==================================================")
print("  USER ULTRA MASTER PRESET 100% APPLIED & SYNCED! ")
print("==================================================")
