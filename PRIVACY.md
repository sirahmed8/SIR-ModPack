...
- ❌ **No Passwords or Sensitive Credentials:** We never store or handle your Microsoft, Xbox Live, or Mojang passwords. Official logins use secure OAuth 2.0 PKCE loopback authentication directly with official Microsoft identity servers.
...
- 💾 **Local Settings:** Visual themes, RAM allocations, JVM runtime flags, screen resolutions, and visual preferences.
